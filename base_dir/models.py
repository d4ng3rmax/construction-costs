...
class Obra(db.Model):
    ...
    lancamentos_custo = db.relationship('LancamentoCusto', back_populates='obra', lazy=True)
    lancamentos_servico = db.relationship('LancamentoServico', back_populates='obra', lazy=True)
    lancamentos_diverso = db.relationship('LancamentoDiverso', back_populates='obra', lazy=True)
...
class LancamentoServico(db.Model):
    ...
    fornecedor = db.relationship('Fornecedores', backref='lancamentos_servico', lazy=True)
